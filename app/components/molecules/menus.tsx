...
const projects = [
  {
    label: "Portfolio Chloé Guillermin Artist",
    color: "#687ce8",
    text: "https://nimble-pika-71f28f.netlify.app/",
    images: [
      {
        ...
        width: 290,
        height: 110,
        className: "absolute right-[228px] top-1 h-[110px]",
      },
      {
        src: "/assets/chloeBis.png",
        alt: "Chloé",
        width: 270,
        height: 110,
        className: "absolute right-132 top-0 h-[110px]",
      },
    ],
  },
  {
    label: "Movies project",
    color: "#3550e1",
    text: "https://github.com/abernardArtefact/movieProject",
  },
