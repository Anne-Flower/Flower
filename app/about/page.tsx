const AboutPage = () => {
  return (
    <section className="pl-[210px] pr-8 pt-[170px] max-w-[1100px]">
      <h2 className="font-['Josefin_Sans'] text-[28px] text-[#300c2a] font-bold uppercase mb-8">
        About
      </h2>
...
{/* fr */}
        <div className="space-y-6 text-[15px] text-[#664060]/80 italic">
          <p>
